ref_dir = '/Users/samwang/Downloads/proj/ref'
dis_dir = '/Users/samwang/Downloads/proj/dis'
...
outfile = open(path + 'labels.txt', 'w')

for i in range(9, len(dis_videos)):
	dis_video = dis_videos[i]
	outfile.write(str(dis_video['dmos']) + '\n')
